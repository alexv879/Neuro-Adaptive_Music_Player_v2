...
from app_configuration import OPENAI_API_KEY, MODEL, MUSIC_FOLDER, USE_LOCAL, AMAZON_MUSIC_URL  # Import settings
    ...
    def __init__(self):
        if USE_LOCAL:  # If using local files, initialize pygame mixer
            try:
                ...
                print(f"Pygame init error: {e}. Switching to Amazon mode.")
                global USE_LOCAL
                USE_LOCAL = False
